                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-3">
                                    <code className="text-sm">username/repo</code>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-3">
                                    <code className="text-sm">github.com/username/repo</code>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-3">
                                    <code className="text-sm">github.com/username/repo/blob/main/file.md</code>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-3">
                                    <code className="text-sm">https://github.com/username/repo</code>
                                </div>
                            </div>
                        </div>
                    </div>
