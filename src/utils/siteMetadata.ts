...
export const siteMetadata = {
    ...
    socialProfiles: {
        github: 'https://github.com/prosamik',
        twitter: 'https://twitter.com/prosamik',
        linkedin: 'https://linkedin.com/in/prosamik'
    },
    organization: {
        name: 'GitHubMe',
        url: 'https://githubme.com',
        logo: 'https://githubme.com/logo.png',
        foundingDate: '2024'
    }
};